...
const commSlide = gsap.timeline();
  ...
  var commTween = commSlide
                        .to(".comm-right", {duration: 3, x:"0%", ease: Power4.easeOut, delay: 0.3}, 0)
                        .to(".comm-right p", {duration: 3, x:"0%", opacity: 1, ease: Power4.easeOut, delay: 1.5}, 0)
                        // .to(".comm-img", {duration: 3, opacity: 1, ease: Power4.easeOut, delay: 1}, 0)
                        .to(".comm-left", {duration: 3, x:"0%", ease: Power4.easeOut}, 0)
                        .to(".question-spin-laura", {duration: 3, opacity: 1, ease: Power4.easeOut, delay: 3}, 0)
