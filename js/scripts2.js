  ...
  transitions: [
    {
      ...
      gsap.set(".hidetext", { y: "110%"});
      gsap.set(".hidetext", { opacity: 0 });
      gsap.set("body", { opacity: 0});
      gsap.set("#desktop", { y: "-50px"});

		  timeline
		  .to("body", { duration: 1.5, opacity: 1, ease: Power4.easeOut, delay: 0.5})
      .to(".hidetext", 1.5, { y: "0%", ease: Power4.easeOut}, 0)
      .to(".hidetext", 2, { opacity: 1, ease: Power4.easeOut}, 0)
...
var rosterTween = new TweenMax.from('#roster', 1.5, { opacity: "0", ease: Power4.easeInOut}); 
